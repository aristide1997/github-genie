...
const WelcomeState: React.FC<WelcomeStateProps> = ({ 
    ...
    const examplePrompts = [
        "Write documentation for repository https://github.com/openai/openai-cookbook",
        "Optimize performance for repository https://github.com/openai/openai-cookbook", 
        "Find and fix 3 bugs in repository https://github.com/openai/openai-cookbook"
    ];
    ...
    return (
        <div className="welcome-state">
            <button 
                className="get-agent-button welcome-get-agent vt-get-agent" 
            ...
            <div className="welcome-content">
                <h1 className="welcome-title vt-title">GitHub Genie</h1>
                <p className="welcome-subtitle">Your AI assistant for GitHub repositories and code analysis</p>
                
                <div className="welcome-input-container">
                    <div className="welcome-input vt-input">
                        <textarea 
                            ref={textareaRef}
                            className="welcome-message-input"
                            placeholder="Ask GitHub Genie to search, find bugs, explore..." 
                            rows={1}
                            value={message}
                ...
                <div className="welcome-examples">
                    ...
                    >
                        📝 Write documentation for repository
                    </div>
                    <div 
                        className="example-prompt" 
